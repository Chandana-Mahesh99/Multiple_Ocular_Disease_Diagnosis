...
from tensorflow.keras.optimizers import Adam12
...
model.save('resnet50_eye_disease_classifier_initial.h5')
...
model.save('resnet50_eye_disease_classifier_finetuned.h5')
